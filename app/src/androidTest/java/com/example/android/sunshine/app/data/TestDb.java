...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        long weatherRowId = weatherDb.insert(WeatherContract.WeatherEntry.TABLE_NAME,null,testWeatherValues);
        ...
        // Move the cursor to a valid database row
        boolean cursorHasRecords = weatherCursor.moveToFirst();
        assertTrue(cursorHasRecords);
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("",weatherCursor,testWeatherValues);
        // Finally, close the cursor and database
        weatherCursor.close();
        weatherDb.close();
    }
